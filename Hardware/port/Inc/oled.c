...
//void menu_show(int8_t level, int8_t suboption0)
//{
//    if(level == 0)
//    {
//        OLED_GRAM_CLR();
//       //OLED_Printf(5,5,10,"voltage adjustment")
//        OLED_Printf(0,0,16, " voltage adjust");
//        OLED_Printf(0,15,16," [2]");
//        OLED_Printf(0,30,16," [3]");
//        OLED_Printf(0,45,16," [4]");
//         OLED_Reflash();
//        switch(suboption0)
//        {
//            case 0:
...
//        {
//            case 0:
//                OLED_Printf(0, 0,16,"Aim voltage:%f",g_aim_voltage);
////                OLED_Printf(0, 16, 16, "Urms=%f",AC_IN.U);
////                OLED_Printf(0, 32, 16, "Irms=%f",AC_IN.I);
////                OLED_Printf(0, 48, 16, "F=%f",AC_IN.F);
//                OLED_Reflash();
//                break;
//            case 1:
//                OLED_Printf(0,0,16,"[2][2]");
//                OLED_Reflash();
//                break;
//            case 2:
//                OLED_Printf(0,0,16,"[3][3]");
//                OLED_Reflash();
//                break;
//            case 3:
//                OLED_Printf(0,0,16,"[4][4]");
//                OLED_Reflash();
//                break;
//        }
//    }
